...
import 'package:photo_test/develop/upload_to_dev_serve.dart';
...
class AssetPathProvider extends ChangeNotifier {
  ...
  //Todo:: 여기서 파이어베이스 스토리지로 올리기
  Future<void> uploadToFirebase(List<AssetEntity> entity) async {
//    final ids = entity.map((e) => e.id).toList();
//    await PhotoManager.editor.deleteWithIds(ids);

    entity.forEach((element) async {
      await UploadToDevServer().upload(element);
    });
  }
